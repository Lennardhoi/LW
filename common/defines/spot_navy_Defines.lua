...
NDefines.NNavy.COMBAT_DAMAGE_TO_STR_FACTOR = 0.18 -- casting damage value to ship strength multiplier. Use it ot balance the game difficulty.
...
NDefines.NAir.NAVAL_STRIKE_DAMAGE_TO_STR = 0.6
