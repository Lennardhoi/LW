...
NDefines.NNavy.NAVY_PIERCING_THRESHOLD_DAMAGE_VALUES = {	---for now we use old system-- 0 armor will always receive maximum damage (so add overmatching at your own peril). the system expects at least 2 values, with no upper limit.
		1.00,
		1.00,
		1.00,
		1.00,
...
NDefines.NNavy.DETECTION_CHANCE_MULT_AIR_SUPERIORITY_BONUS = 0.05
NDefines.NNavy.SPOTTING_ENEMY_SPOTTING_MULTIPLIER_FOR_RUNNING_AWAY = 0.5
NDefines.NNavy.COMBAT_DAMAGE_TO_STR_FACTOR = 0.12 -- casting damage value to ship strength multiplier. Use it ot balance the game difficulty.
...
NDefines.NNavy.BASE_SPOTTING = 0.5
...
NDefines.NAir.NAVAL_STRIKE_CARRIER_MULTIPLIER = 3.05 --was 2.5 but i increased overall naval damage        -- damage bonus when planes are in naval combat where their carrier is present (and can thus sortie faster and more effectively)	
